  ...
  return (
    <div className="mb-3.5">
      <div className="flex justify-between items-baseline mb-1.5">
        ...
        <span className="text-base font-semibold text-text-1 mono">
  ...
  return (
    <aside className="border-l border-border bg-surface overflow-y-auto">
      <div className="px-5 py-4 border-b border-border">
        <div className="text-xs font-semibold uppercase tracking-wider text-text-3 mb-2.5">参数预设</div>
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isActive
                    ? 'bg-surface text-primary shadow-e1 font-semibold'
      ...
      <div className="px-5 py-4">
        <div className="text-xs font-semibold uppercase tracking-wider text-text-3 mb-3">模型杠杆</div>
        {ROWS.map(r => (
      ...
      <div className="px-5 py-4 border-t border-border">
        <div className="text-xs font-semibold uppercase tracking-wider text-text-3 mb-3">人口与策略</div>
        <div className="mb-3.5">
          <div className="flex justify-between items-baseline mb-1.5">
          ...
          {plan.glidePath?.enabled && (
            <div className="mt-3 pl-1">
              <div className="flex justify-between items-baseline mb-1.5">
                ...
                <span className="text-base font-semibold text-text-1 mono">{plan.glidePath?.equityFloorPct ?? 30}%</span>
              </div>
              <Slider
                min={0} max={80} step={5}
