...
export function Tornado() {
 ...
 <span className="px-2 py-0.5 bg-primary/10 text-primary text-sm font-medium rounded-sm">敏感性</span>
 <span className="text-md font-medium text-text-1 tracking-tight">哪个杠杆最能改变 FIRE 时间</span>
 </div>
