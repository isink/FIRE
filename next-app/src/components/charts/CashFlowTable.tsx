  ...
  return (
    <div className="rounded-lg bg-surface shadow-e1 ring-1 ring-border/60 overflow-hidden">
      <div className="px-5 py-3.5 border-b border-border flex items-baseline gap-2">
        <span className="text-md font-semibold text-text-1 tracking-tight">逐年预测</span>
                ...
                >
                  <TableCell
                    className={cn(
                      'mono font-medium',
                      isFireYear
                        ? 'text-primary font-semibold relative pl-3 before:absolute before:left-0 before:top-1 before:bottom-1 before:w-[2px] before:bg-primary before:rounded-full'
